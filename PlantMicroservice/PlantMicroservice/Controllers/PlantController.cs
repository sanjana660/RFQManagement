...
namespace PlantMicros.Controllers
{
    ...
    public class PlantController : ControllerBase
    {
        ...
        //GET: get all part details
        [HttpGet("GetAllPartDetails")]
        ...
        //POST: Add Parts
        [HttpPost("addParts")]
        public async Task<ActionResult<List<Part>>> AddPart(Part p)
        {
        ...
        //POST: Add Part Reorder Details
        [HttpPost("addPartreorder")]
        public async Task<ActionResult<List<PlantReorderDetails>>> AddPartreorderdetails(PlantReorderDetails reorder)
        {
            _context.PlantReoDetail.Add(reorder);
            await _context.SaveChangesAsync();
